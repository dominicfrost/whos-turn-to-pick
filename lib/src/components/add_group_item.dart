...
var AddGroupItem = react.registerComponent(() => new _AddGroupItem());

class _AddGroupItem extends flux.FluxComponent<PickerActions, PickerStore> {
  ...
  _onClick(_) {
    actions.createGroupItem(newMemberValue);
  }
}
